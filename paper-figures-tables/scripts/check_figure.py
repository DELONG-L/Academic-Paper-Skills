"""
paper-figures-tables :: check_figure.py
========================================
...
def _cli() -> int:
    p = argparse.ArgumentParser(description="paper-figures-tables compliance checker")
    ...
    if args.strict and any_fail:
        print("[paper-figures-tables] strict mode: at least one FAIL — exit 2")
        return 2
    return 0
